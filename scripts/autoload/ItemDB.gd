...
const ITEM_TABLE := [
	...
	["catalyst_salt", "錬成塩", "CATALYST", 40, 80, 99, 0.70, 0.70, 0.72, "どの性質にも馴染む塩。弱いがどんな素材のあいだにも挟める万能の緩衝材。"],
	["catalyst_quick", "賢者の水銀", "CATALYST", 70, 140, 99, 0.70, 0.70, 0.72, "どの性質にも馴染む銀色の液。ほどよい魔力を持つ緩衝材。"],
	["catalyst_prima", "第一質料", "CATALYST", 100, 200, 99, 0.70, 0.70, 0.72, "あらゆる性質を併せ持つ原初の粉。強い魔力を注ぎこめる緩衝材。"],
